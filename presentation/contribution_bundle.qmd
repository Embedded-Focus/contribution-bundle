...
- Columns and images
- Code, diagrams, tables, and callouts
...
::: {#fig-demo-architecture}
![](img/architecture.svg){width=80% fig-align="center"}

Example architecture diagram with a numbered caption
:::
...
::: {#fig-mermaid .r-stretch .diagram-full-slide}

```{mermaid}
%% r-stretch uses the remaining Reveal.js slide space; fig-* sizes the rendered diagram.
%%| fig-width: 12
%%| fig-height: 5.8
flowchart LR
...
::: {#fig-dot .r-stretch .diagram-full-slide}
...
| Diagrams | Mermaid and Graphviz code blocks |
